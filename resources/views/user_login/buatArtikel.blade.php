            ...
            <ul class="font-medium flex md:p-0 border-gray-100 md:flex-row space-x-4 rtl:space-x-reverse items-center">
              <li>
                <div class="flex justify-end" id="dropdownButton2">
                    ...
                    <select id="dropdown2" class="absolute z-10 mt-1 w-32 origin-top-right bg-white py-1 shadow-lg ring-1 ring-black-5 focus:outline-none hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1" name="category_id">
