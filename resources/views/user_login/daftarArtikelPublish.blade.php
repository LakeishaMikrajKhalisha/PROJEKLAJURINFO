    ...
    <div class="container mx-auto relative border-t border-gray">
        ...
        <div class="flex items-start">
            ...
            <div class="ml-1 mt-2 mr-2 flex items-start justify-between">
                ...
                <a href="{{ url('artikel-publish/'.$judul->id.'/hapus') }}" class="text-BlueAccent ml-2 mr-1 text-sm hover:text-link items-center flex justify-end" target="_blank">Hapus   
                    <img width="10" class="h-5 w-auto text-grey ml-1" src="{{ asset('storage\trash.svg') }}"/></a>
            </div>
            </div>
            </div>
        </div>
