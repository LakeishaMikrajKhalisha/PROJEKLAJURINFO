...
<body>
    <section class="h-screen w-full flex justify-center items-center">
        <div class="border-2 w-3/4 shadow-md shadow-grey">
            <h1 class="text-center font-semibold text-2xl py-2">Permintaan Hapus Akun</h1>
            <p class="text-center">Berikan Permintaan Hapus Akun atau Artikel Jika Ingin Dihapus</p>
            <form method="POST" action="{{ route('hapus-akun') }}" class="p-4">
                @csrf
